...
describe('UI Protocol Types', () => {
  ...
  describe('createUIMessage', () => {
    it('should create a UI message with automatic timestamp', () => {
      const message = createUIMessage<UIConnectMessage>(
    ...
    it('should create a START_FLOW message with all fields', () => {
      const message = createUIMessage<UIStartFlowMessage>(
    ...
    it('should create a SNAPSHOT message', () => {
      ...
      const message = createUIMessage<UISnapshotMessage>(
        UIMessageType.SNAPSHOT,
        { requestId: 'req-123', snapshot }
      );
  ...
  describe('message serialization round-trip', () => {
    it('should serialize and deserialize CONNECT message', () => {
      const original = createUIMessage<UIConnectMessage>(
        UIMessageType.CONNECT,
        {
          authToken: 'token-123',
    ...
    it('should serialize and deserialize START_FLOW message', () => {
      const original = createUIMessage<UIStartFlowMessage>(
        UIMessageType.START_FLOW,
        {
          requestId: 'req-123',
          flowId: 'my-flow',
    ...
    it('should handle nested objects in message', () => {
      const original = createUIMessage<UIStateUpdateMessage>(
