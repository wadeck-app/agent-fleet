...
export class TaskNotesManager {
	async saveNote(workspacePath: string, taskId: string, filename: string, content: string): Promise<void>;
...
export class ExpressionEvaluator {
	...
	private buildContext(inputs: Record<string, any>, stepOutputs: Map<string, any>, task: Task): EvaluationContext;
}
