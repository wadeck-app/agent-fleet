...
export const validRecipes = {
	chickenWithRice: {
		...
		instructions: 'Faire cuire le riz. Griller le poulet. Cuire le brocoli a la vapeur.',
	},
	salmonPasta: {
...
export const expectedMacros = {
	chickenWithRice: {
		...
		protein: 68.9, // 62 + 4.05 + 2.8 (arrondi a 1 decimale)
		carbs: 49.3, // 0 + 42.3 + 7
		fat: 8.1, // 7.2 + 0.45 + 0.4 (arrondi a 1 decimale)
	},
	salmonPasta: {
		// Saumon 250g: 520 cal, 50g protein, 0g carbs, 32.5g fat
		// Pates 300g: 1113 cal, 39g protein, 225g carbs, 4.5g fat
