...
/**
 * ===========================================================================================
 * S_EDIT: THREE EDIT MODES (Query-Pipeline Approach)
 * ===========================================================================================
 *
 ...
 * - Edit mode determines which components are rendered (PipelineCrudBody or PipelineBody)
 * - Page manages dialog/form state and CRUD operations
 *
 * Features:
 * - Search (debounced via PipelineSearch)
...
function SEditContent({ editMode }: { editMode: EditMode }) {
			...
			<Card>
				<CardContent>
					<PageLayout>
						...
						>
							<SEditContent editMode={editMode} />
						</PipelineDataTable>
					</PageLayout>
				</CardContent>
			</Card>
