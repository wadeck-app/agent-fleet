...
function SelectTrigger({
	...
	return (
		<SelectPrimitive.Trigger
			...
			className={cn(
				`
      flex w-full cursor-pointer items-center justify-between gap-1.5 rounded-lg border
...
function SelectContent({
	...
	return (
       ...
       overflow-y-auto rounded-lg bg-popover text-popover-foreground shadow-md
...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
	return (
		<SelectPrimitive.Item
			...
			className={cn(
				`
      relative flex w-full cursor-default items-center gap-1.5 rounded-md py-1
