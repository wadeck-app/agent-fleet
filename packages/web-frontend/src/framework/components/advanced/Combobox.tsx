...
import { InputGroup } from '@framework/components/advanced/InputGroup/InputGroup';
import { InputGroupAddon } from '@framework/components/advanced/InputGroup/InputGroupAddon';
import { InputGroupButton } from '@framework/components/advanced/InputGroup/InputGroupButton';
import { InputGroupInput } from '@framework/components/advanced/InputGroup/InputGroupInput';
...
function ComboboxChip({
	...
	return (
      ...
      rounded-sm bg-muted px-1.5 text-xs font-medium whitespace-nowrap
      text-foreground
