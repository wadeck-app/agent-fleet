...
import { FLOW_FEEDBACK_MANAGEMENT_ROUTES } from './api/flow-feedback.contract';
import { FLOW_PROPOSALS_API_ROUTES } from './api/flow-proposals.contract';
import { FLOWS_API_ROUTES } from './api/flows.contract';
import { INGREDIENTS_API_ROUTES } from './api/ingredients.contract';
import { INTERVENTIONS_API_ROUTES } from './api/interventions.contract';
import { MONITORING_API_ROUTES } from './api/monitoring.contract';
import { PRODUCTS_API_ROUTES } from './api/products.contract';
...
export const ALL_API_ROUTES = {
	...
	...FLOWS_API_ROUTES,
	...INTERVENTIONS_API_ROUTES,
	...PRODUCTS_API_ROUTES,
	...PROJECTS_API_ROUTES,
	...WORKERS_API_ROUTES,
	...TASKS_API_ROUTES,
	...TICKETS_API_ROUTES,
	...FLOW_PROPOSALS_API_ROUTES,
...
const ALL_CONTRACTS = [
	...
	TICKETS_API_ROUTES,
	FLOW_PROPOSALS_API_ROUTES,
	FLOW_FEEDBACK_MANAGEMENT_ROUTES,
	WORKSPACES_API_ROUTES,
	WORKSPACE_FILES_API_ROUTES,
	WORKSPACE_SCRIPTS_API_ROUTES,
	MONITORING_API_ROUTES,
