...
import { FlowValidator } from '../validation/FlowValidator.js.js';
/**
...
export class FlowRegistry {
     ...
     */
    async parseFlowDefinition(id, data) {
        let baseDefinition = {};
        ...
        return {
            ...
            steps: (mergedData.steps || []).map((step) => this.parseFlowStep(step)),
     ...
     */
    async loadExternalFlowFile(sourcePath, flowId) {
     ...
     */
    validateExternalFilePath(sourcePath, flowId) {
     ...
     */
    mergeFlowDefinitions(external, local) {
     ...
     */
    trackExternalFile(absolutePath) {
        this.externalFiles.add(absolutePath);
    }
    /**
     * Parse workspace configuration
     */
    parseWorkspaceConfig(data) {
        return {
