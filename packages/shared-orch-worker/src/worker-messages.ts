...
export enum W2OMessageType {
	...
	TASK_TRACE_UPDATE = 'w2o:task:trace_update',
...
export interface W2OInterventionRequestedMessage extends W2OBaseMessage {
	...
	workerId: string;
	taskId: string;
	interventionId: string; // Generated by worker, orchestrator must echo it back in response
	flowId?: string;
	stepId: string;
...
export interface W2OMessageMap {
	...
	[W2OMessageType.TASK_TRACE_UPDATE]: W2OTaskTraceUpdateMessage;
