...
describe('FlowDiscoveryRegistry', () => {
	...
	describe('Test 2.1: findWorkersWithFlow - basic queries', () => {
		beforeEach(() => {
			registry.registerWorker('worker1', 'project1', '/path/1', [createFlowMetadata('flow1', '1.0.0', 'hash1')]);
			registry.registerWorker('worker2', 'project1', '/path/2', [createFlowMetadata('flow1', '2.0.0', 'hash2')]);
			registry.registerWorker('worker3', 'project1', '/path/3', [createFlowMetadata('flow2', '1.0.0', 'hash3')]);
		});
	...
	describe('Test 2.2: getLatestVersion', () => {
		it('should return latest version using semver comparison', () => {
			registry.registerWorker('worker1', 'project1', '/path/1', [createFlowMetadata('flow1', '1.0.0', 'hash1')]);
			registry.registerWorker('worker2', 'project1', '/path/2', [createFlowMetadata('flow1', '1.2.0', 'hash2')]);
			registry.registerWorker('worker3', 'project1', '/path/3', [createFlowMetadata('flow1', '1.1.0', 'hash3')]);
		...
		it('should handle major version differences', () => {
			registry.registerWorker('worker1', 'project1', '/path/1', [createFlowMetadata('flow1', '1.9.9', 'hash1')]);
			registry.registerWorker('worker2', 'project1', '/path/2', [createFlowMetadata('flow1', '2.0.0', 'hash2')]);
	...
	describe('Test 2.3: getAllProjects', () => {
		it('should return all registered projects', () => {
			registry.registerWorker('worker1', 'project1', '/path/1', [createFlowMetadata('flow1', '1.0.0', 'hash1')]);
			registry.registerWorker('worker2', 'project2', '/path/2', [createFlowMetadata('flow2', '1.0.0', 'hash2')]);
			registry.registerWorker('worker3', 'project3', '/path/3', [createFlowMetadata('flow3', '1.0.0', 'hash3')]);
	...
	describe('Test 3.2: unregisterWorker - partial cleanup', () => {
		it('should only remove flows for the unregistered worker', () => {
			registry.registerWorker('worker1', 'project1', '/path/1', [createFlowMetadata('flow1', '1.0.0', 'hash1')]);
			registry.registerWorker('worker2', 'project1', '/path/2', [createFlowMetadata('flow1', '1.0.0', 'hash1')]);
		...
		it('should preserve other flows in the same project', () => {
			registry.registerWorker('worker1', 'project1', '/path/1', [createFlowMetadata('flow1', '1.0.0', 'hash1')]);
			registry.registerWorker('worker2', 'project1', '/path/2', [createFlowMetadata('flow2', '1.0.0', 'hash2')]);
