 ...
 * Usage: node ci/scripts/build-launcher.mjs
 */
...
const FLOW_CONFIG = path.join(CI_DIR, 'launcher.config.json');
...
execFileSync('bash', [toUnix(BUILD_SH), toUnix(FLOW_CONFIG), toUnix(OUT_DIR)], { stdio: 'inherit', windowsHide: true });
