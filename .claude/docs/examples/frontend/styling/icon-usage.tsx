  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <nav className="space-y-1">
        ...
        <a href="/calendar" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm hover:bg-accent">
          <Calendar className="h-4 w-4" />
          <span>Calendar</span>
        </a>
        <a href="/settings" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm hover:bg-accent">
