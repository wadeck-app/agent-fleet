  ...
  return (
    <div
      className={cn(
        ...
        variant === 'success' && 'bg-green-50 text-green-900 border-green-200 dark:bg-green-900/20 dark:text-green-100',
        variant === 'warning' && 'bg-yellow-50 text-yellow-900 border-yellow-200 dark:bg-yellow-900/20 dark:text-yellow-100',
        variant === 'error' && 'bg-red-50 text-red-900 border-red-200 dark:bg-red-900/20 dark:text-red-100',
